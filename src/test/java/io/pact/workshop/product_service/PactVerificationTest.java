...
public class PactVerificationTest {
    ...
    void productsExists() {
        ...
        productRepository.saveAll(Arrays.asList(
                new Product(100L, "Test Product 1", "CREDIT_CARD", "CC_001"),
                new Product(200L, "Test Product 2", "CREDIT_CARD", "CC_002"),
                new Product(300L, "Test Product 3", "PERSONAL_LOAN", "PL_001"),
                new Product(400L, "Test Product 4", "SAVINGS", "SA_001")
        ));
    }
    ...
    void productExists(Map<String, Object> params) {
        ...
        if (!product.isPresent()) {
            productRepository.save(new Product(productId, "Product", "TYPE", "001"));
        }
    }
